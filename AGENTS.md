...
This file is the quick-reference operating contract for p256-kotlin. The longer
...
p256-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`p256`](https://crates.io/crates/p256). Upstream Rust is the behavioral oracle while the
