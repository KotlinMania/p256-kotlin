...
kotlin {
    ...
    val xcf = XCFramework("P256")

    macosArm64 {
        binaries.framework { baseName = "P256"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "P256"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "P256"
        flattenPackage = "io.github.kotlinmania.p256"
    }

    android {
        namespace = "io.github.kotlinmania.p256"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "p256-kotlin", version.toString())

    pom {
        name.set("p256-kotlin")
        description.set("Kotlin Multiplatform port of RustCrypto/elliptic-curves - Pure Rust implementation of the NIST P-256 (a.k.a. secp256r1, prime256v1) elliptic curve as defined in SP 800-186, with support for ECDH, ECDSA signing/verification, and general purpose curve arithmetic")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/p256-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/p256-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/p256-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/p256-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleP256XCFramework",
    "assembleP256DebugXCFramework",
    "assembleP256ReleaseXCFramework",
    "assembleDebugIosFatFrameworkForP256XCFramework",
    "assembleReleaseIosFatFrameworkForP256XCFramework",
    "assembleDebugIosSimulatorFatFrameworkForP256XCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForP256XCFramework",
    "assembleDebugMacosFatFrameworkForP256XCFramework",
    "assembleReleaseMacosFatFrameworkForP256XCFramework",
    "assembleDebugTvosFatFrameworkForP256XCFramework",
    "assembleReleaseTvosFatFrameworkForP256XCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForP256XCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForP256XCFramework",
    "assembleDebugWatchosFatFrameworkForP256XCFramework",
    "assembleReleaseWatchosFatFrameworkForP256XCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForP256XCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForP256XCFramework",
