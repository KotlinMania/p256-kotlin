...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `P256.swiftmodule/`
...
//      `import P256` above would fail at compile time.
//
//   2. The static archive `libP256.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "P256" }` and
//      `flattenPackage = "io.github.kotlinmania.p256"` configuration in
...
final class P256ExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "P256 swift module imported cleanly")
    }
}
